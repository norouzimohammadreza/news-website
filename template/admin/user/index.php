        ...
        <table class="table table-striped table-sm">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= jalaliData($user['created_time'])  ?></td>
                    <td>
                        
                   <?php if ($user['is_admin']==0) { ?>
                            <a role="button" class="btn btn-sm btn-success text-white" href="<?=url('admin/user/isadmin'. '/' .$user['id']) ?>">click to be admin</a>
                            <?php }else{ ?>
                <a role="button" class="btn btn-sm btn-warning text-white" href="<?=url('admin/user/isadmin'. '/' .$user['id']) ?>">click not to be admin</a>
                                <?php } ?>
